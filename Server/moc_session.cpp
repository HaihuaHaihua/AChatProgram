...
QT_MOC_LITERAL(1, 8, 15), // "messageRecieved"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 7), // "message"
QT_MOC_LITERAL(4, 33, 6), // "closed"
QT_MOC_LITERAL(5, 40, 11), // "sendMessage"
QT_MOC_LITERAL(6, 52, 10), // "disconnect"
QT_MOC_LITERAL(7, 63, 12) // "dataRecieved"

    },
    "Session\0messageRecieved\0\0message\0"
    "closed\0sendMessage\0disconnect\0"
    "dataRecieved"
};
...
void Session::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Session::messageRecieved)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Session::closed)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Session::messageRecieved(QString _t1)
{
